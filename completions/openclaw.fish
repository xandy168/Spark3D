...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l suppress-gateway-token-output -d 'Suppress token-bearing Gateway/UI output'
...
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l session-key -d 'Explicit session key (agent:<id>:<key>, or scoped to --agent)'
...
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "paste-api-key" -d 'Paste an API key into auth-profiles.json and update config'
...
complete -c openclaw -n "__fish_seen_subcommand_from paste-api-key" -l provider -d 'Provider id (e.g. openai-codex)'
complete -c openclaw -n "__fish_seen_subcommand_from paste-api-key" -l profile-id -d 'Auth profile id (default: <provider>:manual)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l agent -d 'Agent id (default: configured default agent)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l best-effort-deliver -d 'Do not fail job if delivery fails (also implies --announce when used alone)'
